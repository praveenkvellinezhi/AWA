            ...
            {modules.map((m) => (
              ...
              >
                <div className="flex items-center justify-between">
                  <span className="text-xs font-mono font-bold text-cyan-400">MODULE {m.number}</span>
                ...
                <div className="pt-2 flex items-center justify-between text-xs font-semibold text-zinc-300">
