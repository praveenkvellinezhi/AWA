    ...
    <div className="space-y-8 max-w-4xl">
        ...
        {adminConfig.supportedLanguages.map((lang) => (
          ...
          >
            <div className="flex items-center justify-between">
              ...
              <span className="text-xs font-mono font-bold text-indigo-300 px-2 py-0.5 rounded bg-indigo-950/80 border border-indigo-800/50">
      ...
      >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-xs">
          <div>
            <label className="block text-slate-300 font-semibold mb-1">Language Name</label>
            <input
              type="text"
              required
              value={newName}
          ...
          <div>
            <label className="block text-slate-300 font-semibold mb-1">ISO Code</label>
            <input
              type="text"
              required
              value={newCode}
          ...
          <div>
            <label className="block text-slate-300 font-semibold mb-1">Flag Emoji</label>
            <input
              type="text"
              value={newFlag}
