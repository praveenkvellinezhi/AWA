...
export default function AdminVisibilityPage() {
  ...
  return (
    <div className="space-y-8 max-w-4xl">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-slate-200 dark:border-slate-800">
        <div>
          ...
          <h1 className="text-2xl sm:text-3xl font-black text-slate-900 dark:text-white flex items-center gap-2 mt-1">
            <Eye className="h-7 w-7 text-[#15803D] dark:text-emerald-400" />
      ...
      {savedSuccess && (
        <div className="p-3.5 rounded-xl bg-emerald-50 dark:bg-emerald-500/10 border border-emerald-200 dark:border-emerald-500/30 text-emerald-800 dark:text-emerald-300 text-xs flex items-center gap-2 animate-in fade-in duration-200">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
        ...
        <div
          ...
          className={`cursor-pointer rounded-2xl border p-6 flex flex-col justify-between space-y-4 transition-all ${
            visibility === "hard_lock"
              ? "bg-[#EAF5ED]/70 dark:bg-emerald-950/30 border-emerald-600 shadow-md shadow-emerald-700/10 ring-1 ring-emerald-600"
              : "bg-white dark:bg-[#131B2A] border-slate-200 dark:border-slate-800 hover:border-slate-300 dark:hover:border-slate-700 shadow-sm"
          }`}
        >
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              ...
              {visibility === "hard_lock" && (
                <span className="px-2 py-0.5 rounded-full bg-emerald-100 dark:bg-emerald-500/20 text-[10px] font-bold text-emerald-800 dark:text-emerald-300 border border-emerald-200 dark:border-emerald-500/30">
                  ACTIVE RULE
                </span>
              )}
            </div>
            ...
            <div className="p-3 rounded-xl bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 text-[11px] text-slate-600 dark:text-slate-400 space-y-1">
              <span className="font-bold text-slate-900 dark:text-slate-200 block">Security & UX Benefits:</span>
          ...
          <div
            className={`w-full py-2.5 rounded-xl font-bold text-xs text-center border transition-all ${
              visibility === "hard_lock"
                ? "bg-[#008235] border-[#008235] text-white shadow-xs"
        ...
        >
          <div className="space-y-3">
            ...
            <h3 className="text-lg font-bold text-slate-900 dark:text-white flex items-center gap-2">
              <Eye className="h-5 w-5 text-[#15803D] dark:text-emerald-400" />
            ...
            <div className="p-3 rounded-xl bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 text-[11px] text-slate-600 dark:text-slate-400 space-y-1">
              <span className="font-bold text-slate-900 dark:text-slate-200 block">Considerations:</span>
