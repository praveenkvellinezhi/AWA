    ...
    <div className="space-y-8 max-w-4xl">
      ...
      <form onSubmit={handleSave} className="space-y-6">
        ...
        <div className="p-6 rounded-2xl border border-slate-800 bg-slate-900/60 space-y-4">
          <div className="flex items-center justify-between pb-3 border-b border-slate-800">
            <div className="flex items-center gap-2">
              <span className="text-sm font-bold text-white">Razorpay Gateway (Launch Default)</span>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
            <div>
              <label className="block text-slate-300 font-semibold mb-1">Key ID</label>
              <input
                type="text"
                value={rzpKey}
            ...
            <div>
              ...
              <input
                ...
                className="w-full bg-slate-950/60 border border-slate-800 rounded-xl p-2.5 font-mono text-slate-400 select-all"
              />
            </div>
          </div>
        </div>
        ...
        <div className="p-6 rounded-2xl border border-slate-800 bg-slate-900/60 space-y-4">
          <div className="flex items-center justify-between pb-3 border-b border-slate-800">
            <div className="flex items-center gap-2">
              <span className="text-sm font-bold text-white">Stripe Gateway Adapter</span>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
            <div>
              <label className="block text-slate-300 font-semibold mb-1">Publishable Key</label>
              <input
                type="text"
                value={stripeKey}
