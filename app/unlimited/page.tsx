    ...
    <div className="min-h-screen bg-[#0c0d0f] text-slate-100 py-8 px-4 sm:px-6 lg:px-8">
      <div className="w-full space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Card 1: Free Starter */}
          <div className="rounded-2xl border border-zinc-800 bg-[#121316] p-6 flex flex-col justify-between space-y-6">
            <div className="space-y-4">
              <span className="text-xs font-mono font-bold uppercase text-zinc-400">Free Starter</span>
          ...
          <div className="relative rounded-2xl border-2 border-rose-500/60 bg-gradient-to-b from-[#18151f] to-[#121316] p-6 flex flex-col justify-between space-y-6 shadow-2xl shadow-rose-950/20">
            ...
            <div className="space-y-4">
              <span className="text-xs font-mono font-bold uppercase text-rose-300">Unlimited Annual</span>
              <div className="flex items-baseline gap-1">
                <span className="text-3xl font-black text-white">₹199</span>
                <span className="text-xs text-zinc-400">/ year</span>
                <span className="text-[11px] text-zinc-500 line-through ml-1.5">₹999</span>
              </div>
            ...
            {isSubscriber && subscriptionPlan === "yearly" ? (
              <div className="w-full py-3 rounded-xl bg-emerald-500/20 border border-emerald-500/40 text-emerald-300 font-bold text-xs text-center">
                Current Active Plan
              </div>
            ) : (
              <Link
          ...
          <div className="rounded-2xl border border-purple-500/40 bg-[#121316] p-6 flex flex-col justify-between space-y-6">
            <div className="space-y-4">
              <span className="text-xs font-mono font-bold uppercase text-purple-300">Founder Lifetime</span>
              <div className="flex items-baseline gap-1">
                <span className="text-3xl font-black text-white">₹999</span>
                <span className="text-xs text-zinc-500">/ one-time</span>
                <span className="text-[11px] text-zinc-500 line-through ml-1.5">₹2999</span>
              </div>
              <p className="text-xs text-zinc-400">
            ...
            {isSubscriber && subscriptionPlan === "lifetime" ? (
              <div className="w-full py-2.5 rounded-xl bg-purple-500/20 border border-purple-500/40 text-purple-300 font-bold text-xs text-center">
        ...
        {/* Trust Badges */}
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 p-5 rounded-2xl border border-zinc-800 bg-[#121316] text-center text-xs text-zinc-400">
          <div className="flex flex-col items-center gap-1.5">
            <Lock className="h-5 w-5 text-rose-400" />
            <span className="font-bold text-zinc-200">256-Bit SSL</span>
            <span className="text-[10px] text-zinc-500">Bank-grade encryption</span>
          </div>
          <div className="flex flex-col items-center gap-1.5">
            <QrCode className="h-5 w-5 text-emerald-400" />
            <span className="font-bold text-zinc-200">Instant UPI &amp; Cards</span>
            <span className="text-[10px] text-zinc-500">GPay, PhonePe, Cards</span>
          </div>
          <div className="flex flex-col items-center gap-1.5">
            <ShieldCheck className="h-5 w-5 text-indigo-400" />
            <span className="font-bold text-zinc-200">7-Day Guarantee</span>
            <span className="text-[10px] text-zinc-500">100% money back</span>
          </div>
          <div className="flex flex-col items-center gap-1.5">
            <Zap className="h-5 w-5 text-amber-400" />
            <span className="font-bold text-zinc-200">Instant Activation</span>
            <span className="text-[10px] text-zinc-500">Zero wait time</span>
          </div>
        </div>

        {/* Frequently Asked Questions */}
        <div className="rounded-3xl border border-zinc-800 bg-[#121316] p-8 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-xs leading-relaxed">
            <div className="space-y-1.5">
              <h3 className="font-bold text-zinc-200">What do I get with AWA Unlimited?</h3>
            ...
            <div className="space-y-1.5">
              <h3 className="font-bold text-zinc-200">What payment methods are accepted?</h3>
              <p className="text-zinc-400">
            ...
            <div className="space-y-1.5">
              <h3 className="font-bold text-zinc-200">Can I use these prompts for commercial client projects?</h3>
              <p className="text-zinc-400">
            ...
            <div className="space-y-1.5">
              <h3 className="font-bold text-zinc-200">How does the 7-day refund guarantee work?</h3>
              <p className="text-zinc-400">
